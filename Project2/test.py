...
MIPS_STATUS = {
    ...
    "IF_Waiting": " [JR R28]",  # 使IF单元stall的分支指令
    "IF_Executed": "",
...
# instruction_fetched_1 = "BGTZ R12, #231"
# op = instruction_fetched_1.split()[0]
# rs_index = int(instruction_fetched_1[4:].replace(" ", "").split(',')[0][1:])
# offset = int(instruction_fetched_1[4:].replace(" ", "").split(',')[1][1:])
# print(op, rs_index, offset)
